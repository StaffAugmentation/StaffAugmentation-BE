...
public interface IGenericRepository<V, M, K> 
    where V : class
{
    Task<IEnumerable<V>> GetAll(Expression<Func<M, bool>>? criteria = null, string? orderByDirection = null, Expression<Func<M, object>>? orderBy = null);
    Task<V> Find(Expression<Func<M, bool>> criteria);
